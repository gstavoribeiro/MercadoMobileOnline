...
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <a href="<?php echo site_url("admin/formas/criar");?>"class="btn btn-success btn-sm float-left mb-5">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($forma->deletado_em != null):?>
                                        <a href="<?php echo site_url("admin/formas/desfazerexclusao/$forma->id");?>"class="badge badge-dark ml-5">
