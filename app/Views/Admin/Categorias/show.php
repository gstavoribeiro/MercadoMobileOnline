            ...
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php else:?>
                            ...
                            <a data-toggle="tooltip" data-placement="top" title="Desfazer Exclusão" href="<?php echo site_url("admin/categorias/desfazerexclusao/$categoria->id");?>"class="btn btn-dark btn-sm">
